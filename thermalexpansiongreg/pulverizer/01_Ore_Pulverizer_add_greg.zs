        ...
        function addNonGemOreProcessing( inputore as string, outputammount as int, secondaryore as string ) {
            ...
            */
            ...
            //crushed ore oredict names
                ...
                var crushedpureorestring = "crushedPurified" + inputore;
                var secondaryoreduststring = "dust" + secondaryore;
            
            //crushed oredicts
                var ouputoredict = oreDict.get(crushedpureorestring);
            ...
            //ore to crushed ore
                //endstone
                    for ore in endstoneoredict.items {
                        add_Pulverzier_Recipe(outputitemstack * (outputammount * 2), ore, secondoutputitemstack);
                    }
                //normal
                    for ore in oreoredict.items {
                        add_Pulverzier_Recipe(outputitemstack * outputammount, ore, secondoutputitemstack);
                    }
                //nether
        ...
        function addGemOreProcessing(inputore as string, outputammount as int, secondaryore as string) {
            ...
            */
            ...
            //ore to crushed ore
                //endstone
                    for ore in endstoneoredict.items {
                        add_Pulverzier_Recipe(outputitemstack * (outputammount * 2), ore, seondgemoutputitemstack);
                    }
                //normal
                    for ore in oreoredict.items {
                        add_Pulverzier_Recipe(outputitemstack * outputammount, ore, seondgemoutputitemstack);
                    }
                //nether
                    for ore in netheroredict.items {
                        add_Pulverzier_Recipe(outputitemstack * (outputammount * 2), ore, seondgemoutputitemstack);
